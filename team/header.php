      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="addmember.php"><i class="fa fa-user-plus"></i>Add Team-Members</a></li>
            <li><a href="managemember.php"><i class="fa fa-key"></i>Manage Team-Members</a></li>
          </ul>
        </li>
           <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="addproject.php"><i class="fa fa-user-plus"></i>Add Projects</a></li>
            <li><a href="manageproject.php"><i class="fa fa-key"></i>Manage Projects</a></li>
          </ul>
        </li>
           <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="addtask.php"><i class="fa fa-user-plus"></i>Add Tasks</a></li>
            <li><a href="managetask.php"><i class="fa fa-key"></i>Manage Tasks</a></li>
          </ul>
        </li>
          <li class="treeview">
          <a href="#">
