          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
				...
				<?php
					$query="SELECT tbl_login.email_id,tbl_login.login_id,tbl_login.type,tbl_login.phone_no,tbl_detail.name,tbl_detail.designation,tbl_detail.no_of_members_under,tbl_detail.total_seniors,tbl_detail.joining_date,tbl_detail.profile_pic FROM tbl_login INNER JOIN tbl_detail ON tbl_login.login_id=tbl_detail.login_id WHERE(tbl_detail.login_id != '$id' AND tbl_login.type=2) AND tbl_login.active=1";;
                ...
                <tr>
				  ...
				  <td><?php echo $value2['phone_no'];?></td>
                    ...
                    <td><?php echo $value2['no_of_members_under'];?></td>
                    <td><?php echo $value2['total_seniors'];?></td>
                    <td><?php echo $value2['joining_date'];?></td>
