            ...
            <div class="box-body">
              <form role="form" method="POST" action="insert.php" enctype="multipart/form-data" id="myForm">
				...
				<div class="form-group">
                  ...
                  <input type="text" name="desi" class="form-control" placeholder="Enter Designation ..." id="name" required />
                    
                </div>
                   <div class="form-group">
                  <label>No. Of Peoples Under</label>
                  <input type="text" name="junior" class="form-control" placeholder="Enter No of peoples ..." id="name" required />
                    
                </div>
                        <div class="form-group">
                  <label>Total_Seniors</label>
                  <input type="text" name="senior" class="form-control" placeholder="Enter No of Seniors..." id="name" required />
...
<div class="form-group" >
                <label>Joining Date:</label>
					...
					<input type="date" name="join" class="form-control pull-right" id="datepicker" autocomplete="off" required />
					</div>
					<!-- /.input group -->
				</div>
				<div class="form-group" >
