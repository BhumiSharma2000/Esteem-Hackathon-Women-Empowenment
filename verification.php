...
?>
        ...
        <head>
          ...
          <title>SAPDS | Verification Page</title>
        ...
        <div class="login-box">
          ...
          <div class="login-box-body">
            ...
            <form action="" method="post">
              ...
              <div class="row">
               <div class="col-xs-12">
                  <button type="submit" name="submit" class="btn btn-success btn-block btn-flat" style="background-color:#13b1cd">Verify</button>
                </div>
                <!-- /.col -->
                <!-- /.col -->
              </div>
...
//                        }
//                    }
                    else if($otp_num==$otp && $type==3)
                    {
                      $update = "UPDATE tbl_login SET status='1' WHERE login_id='$id'";
                      $result2 = mysqli_query($con,$update);
                      if($result2)
                      {
                        header("location:cmt/dashboard.php");
                      }
                    }
                    else
                    {
                      echo "<br/><font style='color:red;font-size:15px;'><b><center>OOPS!! Incorrect OTP</center></b></font>";
                    }
                }
            ?>	
            <!-- /.social-auth-links -->
